...
ActiveRecord::Schema.define(:version => 20121208193649) do

  create_table "acerca_clientes", :force => true do |t|
    t.string   "image"
    t.integer  "acerca_id"
  ...
  create_table "acercas", :force => true do |t|
    t.string   "image"
    t.string   "title"
  ...
  create_table "producto_details", :force => true do |t|
    t.string   "name"
    t.string   "description", :limit => 1000
    t.string   "image"
  ...
  create_table "ubicacion_details", :force => true do |t|
    t.string   "image"
    t.string   "google_map",   :limit => 1000
    t.string   "name"
    t.string   "address"
    t.string   "telephone"
    t.string   "cellphone"
  ...
  create_table "ultima_instalacions", :force => true do |t|
    t.string   "description"
    t.string   "image"
    t.integer  "acerca_id"
    t.datetime "created_at",        :null => false
